...
export default function BurnishBook() {
  ...
  const slotItems = [
    { id: 1, url: "./src/assets/IMG-458ddbc258ca7631f905f191ccd99e1e-V.jpg" },
    { id: 2, url: "./src/assets/IMG-20250820-WA0001.jpg" },
    { id: 3, url: "./src/assets/IMG_20241211_182234_694.webp" },
    { id: 4, url: "./src/assets/Image_20260731_124320_016.webp" },
    { id: 5, url: "./src/assets/1000016284.jpeg" },
    { id: 6, url: "./src/assets/FB_IMG_1785511724637.jpg" },
  ];
